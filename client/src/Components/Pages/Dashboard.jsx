        ...
        <div className="p-6 md:p-10 w-full max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 py-4 md:py-6">
            ...
            >
              ...
              <span className="mt-4 text-sm text-blue-500 font-medium">View Schedule →</span>
            </Link>
            ...
            >
              ...
              <span className="mt-4 text-sm text-green-500 font-medium">Manage Money →</span>
            </Link>
            ...
            >
              ...
              <span className="mt-4 text-sm text-purple-500 font-medium">Plan Tasks →</span>
            </Link>
            ...
            >
              ...
              <span className="mt-4 text-sm text-orange-500 font-medium">Start Quiz →</span>
            </Link>
          </div>
        </div>
      </div>
